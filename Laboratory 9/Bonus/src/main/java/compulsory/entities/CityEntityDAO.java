...
public class CityEntityDAO {
    ...
    public City findByName(String name) throws SQLException {
        ...
        try (Statement stmt = connection.createStatement();
             ResultSet resultSet = stmt.executeQuery("select country, sister_name, sister_country from bonus_cities where name='" + name + "'")) {
    ...
    public City findById(Integer id) throws SQLException {
        ...
        try (Statement stmt = connection.createStatement();
             ResultSet resultSet = stmt.executeQuery("select name, country, sister_name, sister_country from bonus_cities where id='" + id + "'")) {
